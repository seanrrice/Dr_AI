...
├── fer2013_v2.ipynb              # Jupyter notebook for training, evaluation, and analysis

├── webcam_emotion_mediapipe.py   # Real-time webcam emotion classifier
...
\## 🎥 Real-Time Emotion Detection (`webcam_emotion\_mediapipe.py`)
...
Place your model file here (model is generated by running fer2013_v2 jupyter notebook)
